...
Short, linear, role-based walkthroughs — "what do I do first, then next" — as opposed to the field-by-field reference material in `Design Documents/`, which these guides link out to rather than duplicate.
