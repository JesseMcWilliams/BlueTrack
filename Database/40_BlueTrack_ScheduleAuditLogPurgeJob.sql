...
EXEC msdb.dbo.sp_add_job
    ...
    @enabled = 1,
    @description = 'Nightly audit_event/audit_field_change purge (usp_PurgeAuditLog) for the BlueTrack database, per web.audit_config.RetentionDays. See Claude_Docs/Design_Audit-Logging.md and User_Docs/Admin_OperationsGuide.md.',
    @job_id = @JobId OUTPUT;
