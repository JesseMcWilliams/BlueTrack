...
More report types can be added the same way later; this isn't meant to be exhaustive. **Documentation audit correction, 2026-09-09**: this list only had the original three as of 2026-08-27 — the last two were added since (D-107/D-108, D-119) but never made it back into this list. **Documentation audit correction, 2026-09-21**: same gap recurred — Risk Exception SoD (added the same day as Discovered Accounts) was missing from this list too, found while doing a broader documentation-completeness pass.
